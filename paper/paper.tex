...
GT produces a mean output bias of $\mu = 1.470$, significantly higher than the Base condition, which has $\mu = 0.847$. 
...
PS produces the lowest mean of all conditions ($\mu = 0.507$), with 69.0\% of completions scoring perfect 0. 
