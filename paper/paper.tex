...
We see the result as a broadening of bias rather than an amplification: GT-HB's mean completion bias exceeds GT's on 13 of 15 topics (see Table~\ref{tab:variance_analysis_full}), yet the gains are near-zero on the topics GT already elevated most (climate +0.05, military +0.10).  
