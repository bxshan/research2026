...
from 2017 to 2022, compiling $4.2$ million articles from 488 distinct publishers \cite{verhoeven2024}. Training 
...
The GT-HB result invites another explanation for the bias broadening, which is due to narrowing the number of sources down from the original 488 present in GT to only 76. 
