...
We define bias operationally as the LLM-as-Judge rubric score (Section~\ref{subsec:judge_pipeline}), a 0--5 score of how strongly an article editorializes content, not of its specific ideological direction.
