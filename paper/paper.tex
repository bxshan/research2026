...
\begin{table}[htbp]
  \centering
  \caption{Hallucination rate and precision-corrected bias score per condition. $\mu_{clean}$ corrects for the flag's false-positive rate; $\Delta\mu_{hall.}$ is the numerical reduction. Corrected means are shown only for the three conditions with validated flag precision (GT, GT-HB, Wiki).}
  \vspace{2mm}
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    Base      & 2.0\%      & 0.847       & --            & --                  \\
    GT        & 10.7\%     & 1.470       & 1.439         & +0.031              \\
    PS        & 5.3\%      & 0.507       & --            & --                  \\
    N         & 44.3\%     & 2.153       & 1.484         & +0.669              \\
    GT-HB     & 12.0\%     & 1.763       & 1.686         & +0.077              \\
    \bottomrule
  \end{tabular}
\end{table}
